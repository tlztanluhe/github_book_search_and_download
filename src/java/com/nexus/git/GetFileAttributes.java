...
/*
 * Copyright 2013, 2014 Dominik Stadler Licensed under the Apache License, Version 2.0 (the
...
/**
 * Snippet which shows how to use RevWalk and TreeWalk to read the file attributes like
 * execution-bit and type of file/directory/...
 *
...
public class GetFileAttributes {
  ...
  public static void main(String[] args) throws IOException {
    try (Repository repository = CookbookHelper.createNewRepository()) {
      ...
      // there is also FileMode.SYMLINK for symbolic links, but this is
  ...
  private static void printDirectory(Repository repository, RevTree tree) throws IOException {
    ...
    try (TreeWalk treeWalk = new TreeWalk(repository)) {
      ...
      FileMode fileMode = treeWalk.getFileMode(0);
      System.out.println("src: " + getFileMode(fileMode) + ", type: " + fileMode.getObjectType()
          + ", mode: " + fileMode);
    }
  }
